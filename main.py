...
if __name__ == "__main__":
    ...
    parser.add_argument("--learning_rate", type=float, default=0.011044351)
    ...
    parser.add_argument("--num_epochs_per_decay", type=int, default=16)
    parser.add_argument("--decay_factor", type=float, default=0.848138679)
    parser.add_argument("--num_epochs_till_restart", type=int, default=13)
